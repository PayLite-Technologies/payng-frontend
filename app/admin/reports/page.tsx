    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {[
            { label: "Total Revenue", value: "₦2.5B", change: "+15%" },
            { label: "Active Institutions", value: "1,250", change: "+5%" },
            { label: "Total Transactions", value: "45,000", change: "+12%" },
            { label: "Average Transaction", value: "₦55,000", change: "+3%" },
          ].map((stat) => (
            <motion.div
              key={stat.label}
